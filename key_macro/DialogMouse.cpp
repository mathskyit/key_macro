...
BOOL CDialogMouse::OnInitDialog()
{
	...
	char message[256];
	sprintf (message, "%s를 눌러 커서 위치를 획득합니다.", g_vk_list[getVkIndex (ini_mouseCaptureKey)].desc);
	...
	SendDlgItemMessage (IDC_COMBO_BUTTON_SELECT, CB_ADDSTRING, 0, (LPARAM)"(선택안함)");
	SendDlgItemMessage (IDC_COMBO_BUTTON_SELECT, CB_ADDSTRING, 0, (LPARAM)"왼쪽 버튼");
	SendDlgItemMessage (IDC_COMBO_BUTTON_SELECT, CB_ADDSTRING, 0, (LPARAM)"오른쪽 버튼");
	SendDlgItemMessage (IDC_COMBO_BUTTON_SELECT, CB_ADDSTRING, 0, (LPARAM)"중앙 버튼");
	SendDlgItemMessage (IDC_COMBO_BUTTON_SELECT, CB_ADDSTRING, 0, (LPARAM)"X1 버튼");
	SendDlgItemMessage (IDC_COMBO_BUTTON_SELECT, CB_ADDSTRING, 0, (LPARAM)"X2 버튼");
...
void CDialogMouse::OnMouseCapture ()
{
...
void CDialogMouse::OnBnClickedOk()
{
	...
	if (IsDlgButtonChecked (IDC_CHECK_MOVE)) {
